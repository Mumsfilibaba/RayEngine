...
namespace RayEngine
{
	namespace Graphics
	{
		...
		{
		public:
			VulkanDeviceContext(const VulkanDeviceContext& other) = delete;
			VulkanDeviceContext& operator=(const VulkanDeviceContext& other) = delete;
			VulkanDeviceContext(VulkanDeviceContext&& other) = delete;
			VulkanDeviceContext& operator=(VulkanDeviceContext&& other) = delete;

		public:
			VulkanDeviceContext(IDevice* pDevice, bool isDeffered);
			~VulkanDeviceContext();
