...
namespace RayEngine
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
	void RAYENGINE_API QuerySystemDesc(SystemDesc* pDesc);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
	void RAYENGINE_API SendQuitMessage(int32 exitCode);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
	void RAYENGINE_API CreateSystemWindow(IWindow** ppWindow, WindowDesc* pDesc);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
	void RAYENGINE_API CreateDevice(Graphics::IDevice** ppDevice, Graphics::DeviceDesc* pDesc, GRAPHICS_API api);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
	void RAYENGINE_API CreateWindowForRendering(IWindow** ppWindow, const WindowDesc* pWindowDesc,
