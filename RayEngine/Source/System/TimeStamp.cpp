...
namespace RayEngine
{
	...
	{
		m_Nanoseconds += static_cast<int64>(seconds * 1000 * 1000 * 1000);
	}

	void TimeStamp::AddMilliSeconds(double milliseconds)
	{
		m_Nanoseconds += static_cast<int64>(milliseconds * 1000 * 1000);
	}

	void TimeStamp::AddMicroSeconds(double microseconds)
	{
		m_Nanoseconds += static_cast<int64>(microseconds * 1000 * 1000);
	}
	...
	{
		return GetAsMicroSeconds() / 1000;
	}

	double TimeStamp::GetAsMicroSeconds() const
	{
		return GetAsNanoSeconds() / 1000;
	}
