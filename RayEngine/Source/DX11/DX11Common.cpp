...
namespace RayEngine
{
	namespace Graphics
	{
		...
		D3D11_BLEND_OP ReToDX11BlendOp(BLEND_OPERATION operation) 
		{
			switch (operation)
			{
			case BLEND_OPERATION_OP_SUBTRACT: return D3D11_BLEND_OP_SUBTRACT;
			case BLEND_OPERATION_OP_REV_SUBTRACT: return D3D11_BLEND_OP_REV_SUBTRACT;
			case BLEND_OPERATION_OP_MIN: return D3D11_BLEND_OP_MIN;
			case BLEND_OPERATION_OP_MAX: return D3D11_BLEND_OP_MAX;
			case BLEND_OPERATION_OP_ADD: 
		...
		D3D11_STENCIL_OP ReToDX11StencilOp(STENCIL_OPERATION operation)
		{
			switch (operation)
			{
			case RayEngine::STENCIL_OPERATION_ZERO: return D3D11_STENCIL_OP_ZERO;
			case RayEngine::STENCIL_OPERATION_REPLACE: return D3D11_STENCIL_OP_REPLACE;
			case RayEngine::STENCIL_OPERATION_INCR_SAT: return D3D11_STENCIL_OP_INCR_SAT;
			case RayEngine::STENCIL_OPERATION_DECR_SAT: return D3D11_STENCIL_OP_DECR_SAT;
			case RayEngine::STENCIL_OPERATION_INVERT: return D3D11_STENCIL_OP_INVERT;
			case RayEngine::STENCIL_OPERATION_INCR: return D3D11_STENCIL_OP_INCR;
			case RayEngine::STENCIL_OPERATION_DECR: return D3D11_STENCIL_OP_DECR;
			case RayEngine::STENCIL_OPERATION_KEEP:
			case RayEngine::STENCIL_OPERATION_UNKNOWN:
